...
class ChildTypeNumber extends Component {
        ...
        return (
            <div>
                <div className="Add-type-child">
                    ...
                    <input type="number" ref={(input) => this.textInput = input} defaultValue={this.props.item.items} />
...
export default connect(storeConnect)(ChildTypeNumber);
